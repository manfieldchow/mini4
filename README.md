...
- **Dependency:** [Microsoft NeoPixel](https://github.com/microsoft/pxt-neopixel) (loaded automatically)
...
**Important:** use version **0.7.0** with tag `v0.7.0`. See [INSTALL.md](INSTALL.md).
